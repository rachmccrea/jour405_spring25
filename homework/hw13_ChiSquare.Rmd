...
Looks like there were more As than were expected, a few more Bs, and fewer Cs. There were more Ds, but fewer Fs. I think these differences are meaningful, especially the differences in As and Cs. The difference of 20 instances for those two grades seems meaningful.  
...
The critical value is 9.4877. The chi-square statistic is 11.667. Since the chi-square statistic is greater than the critical value here, we should reject the null hypothesis. 
...
The two most noticeable differences are the increase in As and Cs. I'd ask istructors if they're noticing a widening gap between students: are more students performing above a B-level while more are performing below? If there's fewer Bs, that could mean that some students are falling behind while others are getting ahead. Which students are getting more Cs, and what academic resources do they have access to? What about the students getting more As? Does the instructor have any idea why this could be happening? 