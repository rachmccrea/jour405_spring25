...
It's definitely looking like the spike led to a sustained higher car theft rate. Specifically looking at mean_rate, the pre-spike rate was about 23 and the post-spike rate was about 43. That's almost a doubling. 
...
This chart shows the rate of car thefts by month since 2017 and highlights 2023. It shows that rates are still higher than they were from 2017-2022, though they've declined from 2023 levels. 

Better title: "Car theft rate declines from spike, but remains high"
...
- **Null Hypothesis (H0)**: The car theft rate spike did NOT lead to consistently higher car theft rates. 

- **Alternative Hypothesis (H1)**: The car theft rate spike DID lead to consistent higher car theft rates. 
...
The F-value is high and the P-value is very low, which is statistically significant. I'd say there are real differences here. 
...
There is a significant difference between these three periods -- there is a legit difference between pre-spike and post-spike car theft rates. Car theft rates are higher in the post-spike period than they were before the spike. 

HEADLINE: Car theft rate remains high after dropping from record levels 
LEDE: Car thefts have dropped since a huge spike in 2023, but they are still significantly higher than they were in years before the upswing.
