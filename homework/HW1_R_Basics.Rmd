...
When I hit library(tidyverse), the console told me that there were conflicts wtih dplyr::filter() and dplyr::lag(). I looked it up and it looks like that's normal, will this give me trouble in the future? 
