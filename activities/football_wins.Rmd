...
I don't think it's a very useful model. It can tell us some useful things about might or might not have some impact on wins, but the residuals and residual standard error are too large to use it to make confident preditions. I wouldn't use it to make predictions for my teams.  
