...
It looks like there are actually differences between community, private, and public school SAT scores. Private schools have the highest mean score (1435), public schools have the second-highest mean score (1360), and community colleges have the lowest (1068). This trend of private #1, public #2, and community #3 is the same for median and minimum scores, but public and private schools both have a max score of 1600. The standard deviation is interesting -- private schools have a smaller standard deviation than public and community colleges. 
...
#helps us see differences between pairs 
...
Yes, there is a significant difference in SAT scores. The summary statistics back that up, and so does the ANOVA test and the Tukey test. 
2. Which specific college types differ from each other?
Private schools score the highest, and community colleges score the lowest on average. Public schools are in the middle, but scores are generally closer to private schools than community colleges. This is shown by the data visualizations we made with the summary statistics.
3. How large are these differences?
They're pretty large, especially between community and private colleges. The ANOVA test gives us a really large F-value, which points to big differences between college types. 
...
HEADLINE: Private colleges have the highest SAT scores, data show 
LEDE: Students at private colleges scored higher on the SAT on average compared to students at public universities and community colleges, according to a data analysis.
NEXT COUPLE SENTENCES: The data point to large differences in test scores between students at these types of schools. Community college students generally scored well below students at both public and private univerisites. 
Private schools had an average SAT score of about 1435. Public school students scored about 1360, and community college students had a lower average score of 1068. 
