...
Yes, the observed data is different than expected. There are fewer 5-star reviews than expected, and fewer 3-star reviews. However, there are more 4-star, 2-star, and 1-star reviews than expected. The biggest differences were between expected and observed 5-star reviews, and expected and observed 2-star reviews. 
...
Yes, we can reject the null hypothesis because the chi-square value of 9.95 is greater than the critical value of 9.48. There's a solid difference between observed & expected movie ratings. 
