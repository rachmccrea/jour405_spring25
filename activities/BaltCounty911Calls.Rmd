...
- Z-scores between -2 and 2 represent typical values (about 95% of the data) lastly look at normal 
- Z-scores beyond ±2 indicate unusual values that warrant investigation then look at weird
- Z-scores beyond ±3 are very unusual (only about 0.3% of normally distributed data) look at bizarre first
...
I would draw the lines at about 16 and about 5, probably. Anthing above or below that would be weird. 
...
They marked unusual days a little bit above where I did. I said I'd draw a line at about 16 and they started marking days around 17 or 18. R also highlighted days with a lower volume of calls than I did -- I said to start at 5 and the code marks stuff around 3. 
```{r plot-unusual-days}
...
Saturdays usually see the most 911 overdose calls in Baltimore County. It sees the most days with unusually high numbers of 911 calls than the other six days of the week, though Friday also sees many unusually busy days. 
...
I'd want to continue to dig into this because of the seasonal changes. It looks like there's something going on during the springtime, and during September. I'd want to know if this is a supply thing like a classmate mentioned, or if more lethal batches enter the community during the spring months for some reason. I'd want to look at who is overdosing, if many overdoses are in the same neighborhood, and how this changes over time. Diving deeper into seasonal patterns, including the spring spike and the September decrease, could be really helpful for learning more about patterns. That might be useful for prevention work as well as journalism. 
