...
#each group is a team, you want one column per team 
#group_by doesn't work unless you follow it up w summarize 
```
...
#rankings don't give enough context. PERCENTILE does!
```
...
Maryland volleyball was ranked 140th in the NCAA and had a 5-15 conference record, but was ranked in the 95th percentile for service out of all teams in the NCAA. They were pretty bad overall but had great service. 
